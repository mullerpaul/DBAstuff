...
--candidate quality==============================================================
  ...
  insert into default_metric_weights (metric_guid, weight_for_category)
  values (lv_guid, 0.11);
  
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 10000, 500, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 500, 100, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 100, 50, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 50, 25, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 25, 1, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 10, 0, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 20, 10, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 50, 20, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 100, 50, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 250, 100, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 50, 25, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 25, 20, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 20, 15, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 15, 10, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 10, 0, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 100, 80, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 80, 60, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 60, 40, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 40, 20, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 20, 0, 1, 'F');
  ...
  values (lv_guid, 10, 0, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 50, 10, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 250, 50, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 500, 250, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 1000, 500, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 10, 8, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 8, 6, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 6, 4, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 4, 2, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 2, 0, 1, 'F');
...
--efficiency==============================================================
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 5, 0, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 10, 5, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 14, 10, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 31, 14, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 45, 31, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 2, 0, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 5, 2, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 10, 5, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 14, 10, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 21, 14, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 3, 0, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 7, 3, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 14, 7, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 21, 14, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 31, 21, 1, 'F');
...
--cost==============================================================
  ...
  values (lv_guid, 10, 0, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 25, 10, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 50, 25, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 500, 50, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 1000, 500, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 20, 0, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 40, 20, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 60, 40, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 80, 60, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 100, 80, 1, 'F');
  ...
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 100000000, 1000000, 10, 'A');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 1000000, 500000, 8, 'B');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 500000, 250000, 6, 'C');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 250000, 100000, 4, 'D');
  insert into default_metric_multiplier(metric_guid, less_than, greater_than_or_equal, calc_val, range_grade)
  values (lv_guid, 100000, 0, 1, 'F');
