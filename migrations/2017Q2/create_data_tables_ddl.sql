...
PARTITION BY HASH (client_guid) -- originally planned a different partitioning scheme suited for partition exchange loading but 
PARTITIONS 128                  -- we are giving up on that for now.  Instead using hash partitioning in hopes of speeding the merge loads.
/
