DECLARE
  lv_source     processing_log.source%TYPE := 'msvc-3963_get_historical_data_ut03.sql';
  lv_msg        VARCHAR2(255);
...
BEGIN
  ...
  logger_pkg.set_code_location('msvc-3963_get_historical_data_ut03');
