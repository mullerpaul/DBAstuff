/*******************************************************************************
SCRIPT NAME         release_submission_beeline_mv.sql
 
OBJECT NAME         release_submission_beeline_mv
...
CREATE MATERIALIZED VIEW release_submission_beeline_mv
...
SELECT r.release_guid,
 ...
 WHERE r.release_guid = s.release_guid(+)  -- outer join because releases may not have submissions
   AND r.legacy_source_vms = 'Beeline'
/
