DECLARE
  lv_object_name lego_refresh.object_name%TYPE := 'LEGO_ASSGN_LOC_CMSA_ATOM_RR';
...
BEGIN
  ...
  VALUES
    (lv_object_name,
     ...
     lv_syn_name || '2',
     lv_syn_name,
     'lego_dashboard_refresh.assgn_loc_cmsa_atom_rr');

  INSERT INTO lego_refresh_index (object_name, source_name, index_name, index_type, column_list, tablespace_name)
       VALUES (lv_object_name,'USPROD','ASSGN_LOC_CMSA_ATOM_RR_NI01','NONUNIQUE','LOGIN_USER_ID,CMSA_PRIMARY_STATE_CODE',NULL);
