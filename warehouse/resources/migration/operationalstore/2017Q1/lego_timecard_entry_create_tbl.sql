BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE lego_timecard_entry PURGE';
EXCEPTION  
  WHEN OTHERS THEN 
    NULL;
END;
...
CREATE TABLE lego_timecard_entry (
buyer_enterprise_bus_org_id    NUMBER(38) NOT NULL,
buyer_org_id                   NUMBER(38) NOT NULL,
supplier_org_id                NUMBER(38) NOT NULL,
timecard_entry_id              NUMBER(38) NOT NULL,
timecard_id                    NUMBER(38) NOT NULL,
assignment_continuity_id       NUMBER(38) NOT NULL,
wk_date                        DATE NOT NULL,
week_ending_date               DATE NOT NULL,
tc_create_date                 DATE NOT NULL,
tc_last_update_date            DATE,
tce_create_date                DATE NOT NULL,
timecard_number                VARCHAR2(256),
timecard_type                  VARCHAR2(24) NOT NULL,
is_break                       NUMBER(1),
hours                          NUMBER(38,2),
change_to_hours                NUMBER(38,2),
state_code                     NUMBER(38) NOT NULL,
timecard_approval_workflow_id  NUMBER(38),
timecard_approver_id           NUMBER(38),
tc_udf_collection_id           NUMBER(38),
tce_udf_collection_id          NUMBER(38),
cac1_id                        NUMBER(38),
cac2_id                        NUMBER(38),
...
load_date                      DATE)
  ...
  SUBPARTITION TEMPLATE(
    SUBPARTITION P_LT_Q1_2003 VALUES LESS THAN (TO_DATE('01/01/2003','MM/DD/YYYY')),     
    SUBPARTITION P_Q1_2003 VALUES LESS THAN (TO_DATE('04/01/2003','MM/DD/YYYY')),
    SUBPARTITION P_Q2_2003 VALUES LESS THAN (TO_DATE('07/01/2003','MM/DD/YYYY')),
    SUBPARTITION P_Q3_2003 VALUES LESS THAN (TO_DATE('10/01/2003','MM/DD/YYYY')),
    SUBPARTITION P_Q4_2003 VALUES LESS THAN (TO_DATE('01/01/2004','MM/DD/YYYY')),
    SUBPARTITION P_Q1_2004 VALUES LESS THAN (TO_DATE('04/01/2004','MM/DD/YYYY')),
    SUBPARTITION P_Q2_2004 VALUES LESS THAN (TO_DATE('07/01/2004','MM/DD/YYYY')),
    SUBPARTITION P_Q3_2004 VALUES LESS THAN (TO_DATE('10/01/2004','MM/DD/YYYY')),
    SUBPARTITION P_Q4_2004 VALUES LESS THAN (TO_DATE('01/01/2005','MM/DD/YYYY')),   
    SUBPARTITION P_Q1_2005 VALUES LESS THAN (TO_DATE('04/01/2005','MM/DD/YYYY')),
    SUBPARTITION P_Q2_2005 VALUES LESS THAN (TO_DATE('07/01/2005','MM/DD/YYYY')),
    SUBPARTITION P_Q3_2005 VALUES LESS THAN (TO_DATE('10/01/2005','MM/DD/YYYY')),
