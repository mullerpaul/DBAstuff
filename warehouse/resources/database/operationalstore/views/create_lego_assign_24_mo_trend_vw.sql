    CREATE OR REPLACE VIEW lego_assign_24_mo_trend_vw
    AS  
   SELECT YR,
          MO,
          DAY,
   ...
   FROM lego_assign_month_trend_vw
  WHERE newdate between  ADD_MONTHS (TRUNC (SYSDATE, 'mm'), -24) and trunc(sysdate,'mm')-1
/