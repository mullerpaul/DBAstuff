CREATE OR REPLACE VIEW lego_assign_month_trend_vw
AS
   SELECT DTS.YR,
          DTS.MO,
          DTS.DAY,
      ...
      FROM dts_by_month dts
          LEFT OUTER JOIN lego_all_assignment_types_vw asg
             ON     dts.newdate >= TRUNC (assignment_start_dt, 'mm')
                AND dts.newdate <= TRUNC (assignment_actual_end_dt, 'mm')
/             
